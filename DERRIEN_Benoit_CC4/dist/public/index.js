 ...
 *      description: Afficher tous les liens (API)
 *      responses:
 *          '200':
 *              description: Lien raccourcié
 *          '400':
 ...
 *      description: Supprimer un lien (API)
 *      responses:
 *          '200':
 *              description: Lien raccourcié
 *          '400':
...
form.addEventListener("submit", async (event) => {
    ...
    try {
        let request = await (await fetch(`${API_URL}api/shorten`, { // Utilisez API_URL ici
            method: 'POST',
            headers: {
